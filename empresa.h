...
struct nodo_empresa{
	...
	Cadena cargo; // Nombre del cargo
    vector<nodo_empresa*> subcargos; // Subcargos dependientes
    vector<Persona> personas; // Personas asociadas al cargo

    // Constructor para inicializar el nodo con el nombre del cargo
    nodo_empresa(const Cadena& nombre) : cargo(nombre) {}
};
